...
while running:
    ...
    dw(["minuten", "halb", "nach", "eins"], [(1 if minute >= 35 and minute < 45 or minute >= 50 else 0),(1 if minute == 25 else 0),(1 if minute < 30 and minute >= 5 else 0),(1 if hour == 1 else 0)], line3)
