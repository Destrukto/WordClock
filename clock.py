...
while running:
    ...
    dw(["viertel","fünf", "zwanzig", "vor" ], [
        ...
        (1 if minute >= 20 and minute < 25 or minute >= 35 and minute < 45 else 0),
        (1 if minute >= 35 or minute >= 25 and minute <= 30 else 0)], line2)
    dw(["minuten", "halb", "nach", "eins"], [(1 if minute >= 35 and minute < 45 or minute >= 50 else 0),(1 if minute >= 25 and minute < 30 else 0),(1 if minute < 25 and minute >= 5 else 0),(1 if hour == 1 else 0)], line3)
